...
class CustomerMenuPhotoCVC: UICollectionViewCell, ModelCollectionViewCellProtocol {
    ...
    var model: ModelCollectionViewCellModelProtocol? {
        didSet {
            if let model: CustomerMenuPhotoVM = model as! CustomerMenuPhotoVM? {
