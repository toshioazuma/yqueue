//
//  CustomerMenuOptionAlertVC.swift
//  YQueue
//
...
class CustomerMenuOptionAlertVC: AlertVC {
    ...
    static func show(in vc: UIViewController, withOptions options: Array<MenuItem.Option>, optionLabel: UILabel, selectionCallback: @escaping (MenuItem.Option) -> Void, offsetCallback: @escaping (CGFloat) -> Void) -> CustomerMenuOptionAlertVC {
