...
let kDefaultOriginY: CGFloat = 0.0
...
public class BadgedBarButtonItem: UIBarButtonItem {
    ...
    var badgeOriginY: CGFloat = kDefaultOriginY /*{
        get {
...
extension BadgedBarButtonItem {
    ...
    func updateBadgeProperties() {
        if let customView = self.customView {
            badgeOriginX = customView.frame.size.width/2
            badgeOriginY = customView.frame.size.width/2 - badgeLabel.frame.size.height
        }
    }
}
